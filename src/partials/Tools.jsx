  ...
  return (
    <article id="tools" className="bg-base-200 py-12 text-white">
      <div className="px-4 space-y-4">
        <section>
          <h2 className="text-3xl font-bold mb-6">What can I do? 🤖</h2>
          <p>
        ...
        <section>
          <p className="mb-4">Here, the tech stack and tools that I use:</p>
          <ul className="flex flex-col gap-4">
            <li>
              <article className="p-4 rounded-md border-4 space-y-2">
                  ...
                  <ul className="flex flex-row flex-wrap">
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiHtml5 className="inline-block w-6" />
                        <p className="inline-block">HTML</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiCss3 className="inline-block w-6" />
                        <p className="inline-block">CSS</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiJavascript className="inline-block w-6" />
              ...
              <article className="p-4 rounded-md border-4 space-y-2">
                ...
                <div>
                  <ul className="flex flex-row flex-wrap">
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiMysql className="inline-block w-6" />
                        <p className="inline-block">MySQL</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiMariadb className="inline-block w-6" />
                        <p className="inline-block">MariaDB</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiPostgresql className="inline-block w-6" />
                        <p className="inline-block">PostgreSQL</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiRedis className="inline-block w-6" />
              ...
              <article className="p-4 rounded-md border-4 space-y-2">
                ...
                <div>
                  <ul className="flex flex-row flex-wrap">
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiLinux className="inline-block w-6" />
                        <p className="inline-block">Linux</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiApache className="inline-block w-6" />
                        <p className="inline-block">Apache</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiNginx className="inline-block w-6" />
                        <p className="inline-block">Nginx</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiDocker className="inline-block w-6" />
              ...
              <article className="p-4 rounded-md border-4 space-y-2">
                ...
                <div>
                  <ul className="flex flex-row flex-wrap">
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiGit className="inline-block w-6" />
                        <p className="inline-block">Git</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiGithub className="inline-block w-6" />
                        <p className="inline-block">Github</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiVisualstudiocode className="inline-block w-6" />
                        <p className="inline-block">VS Code</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiJetbrains className="inline-block w-6" />
                        <p className="inline-block">Jetbrains&apos;</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiOpenapiinitiative className="inline-block w-6" />
                        <p className="inline-block">OpenAPI</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiUml className="inline-block w-6" />
                        <p className="inline-block">PlantUML</p>
                      </div>
                    </li>
                    <li className="basis-1/2">
                      <div className="py-2 space-x-2">
                        <SiFigma className="inline-block w-6" />
