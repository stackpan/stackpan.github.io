...
function Projects() {
  return (
    <article id="about" className="bg-base-100 py-12 text-black">
      <div className="px-4">
        <section>
          <h2 className="text-3xl font-bold mb-6">My Works 🏗️</h2>
          <p className="mb-4">Check out my project(s) for the sake of society:</p>
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <article className="p-4 rounded-md border-4 border-black space-y-2">
                  ...
                  <div>
                    <img src={simplizLogo} alt="Simpliz Screenshot" className="rounded border-2 border-black" />
              ...
              <li>
                <article className="p-4 rounded-md border-4 border-black space-y-2">
                  ...
                  <div>
                    <img src={laravelNotesServerSwagger} alt="laravel-notes-server swagger screenshot" className="rounded border-2 border-black" />
              ...
              <li>
                <article className="p-4 rounded-md border-4 border-black space-y-2">
                  ...
                  <div>
                    <img src={qurancordScreenshot} alt="Qurancord Demu Screenshot" className="rounded border-2 border-black" />
          ...
          <section className="mb-8">
            <h3 className="mb-4 text-xl">Legacy project(s):</h3>
            <ul className="flex flex-col gap-4">
              <li>
                <article className="p-4 rounded-md border-4 border-black space-y-2">
                  <header>
                  ...
                  <div>
                    <img src={ayopklUiScreenshot} alt="AyoPKL UI Screenshot" className="rounded border-2 border-black" />
              ...
              <li>
                <article className="p-4 rounded-md border-4 border-black space-y-2">
                  ...
                  <div>
                    <img src={ppdbDesktopThumbnail} alt="PPDB Desktop thumbnail" className="rounded border-2 border-black" />
